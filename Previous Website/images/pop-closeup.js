...
var view_width = 450
var view_height = 420
var look='toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=0,width='+view_width+',height='+view_height+','
popwin=window.open("","",look)
popwin.document.open()
popwin.document.write('<title>Original Size of Photo</title><head>')
popwin.document.write('<META HTTP-EQUIV="imagetoolbar" CONTENT="no">')
popwin.document.write('<script language="JavaScript">')
popwin.document.write('function noRightClick() {')
popwin.document.write('if (event.button==2) {')
popwin.document.write('alert(\'If you like this photo please contact us!\')')
...
popwin.document.write('<TABLE cellpadding=0 cellspacing=0 border=1 bordercolor="#FF9900"><tr><td>')
popwin.document.write('<img src="'+URL+'">')
popwin.document.write('</td></tr></table>')
popwin.document.write('</td></tr><tr><td valign="bottom" align="center">')
popwin.document.write('<br><form><input type=submit value="Close" style=\'border:#FF9900 1px solid\' onClick=\'self.close()\'></form><br>')
